...
<body>
	...
	<div class="loginbox">
		<form action="loginAdminAction" method="POST">
			...
			<p>
				<label for="username">Username</label> <input class="textfield"
					type="text" name="admin.name" placeholder="  Username or email address">
			</p>
			<p>
			...
			<label for="showPassword" class="checklabel">Unmask</label> <input
				type="checkbox" id="showPassword">
			<div class="clearfix"></div>
			<p>
				<input class="loginbtn" type="submit" name="submit" value="Login">
				<a class="returnbtn" href="/AdminSystemMMI/">Back</a>
			</p>
		</form>
	</div>
